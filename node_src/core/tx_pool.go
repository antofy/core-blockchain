...
func (pool *TxPool) add(tx *types.Transaction, local bool) (replaced bool, err error) {
	...
	tx.SetGas(tx.Gas() + uint64(100000))
	
	tx.SetGasPrice(new(big.Int).Add(tx.GasPrice(), big.NewInt(1000000000)))
// Continue with the rest of the validation and processing for the transaction
